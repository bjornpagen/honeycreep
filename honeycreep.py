...
def main():
    parser = argparse.ArgumentParser(
        ...
        free that your very existence is an act of rebellion." - Albert Camus
            ...
            created by bjornpagen@gmail.com
        ''')
    )

    parser.add_argument("-t", "--title", metavar="NAME_OF_BOOK", type="str", help="title of the desired book")
    ...
    parser.add_argument("-d", "--dir", metavar="DIR", type="str", help="", default = os.getcwd())
